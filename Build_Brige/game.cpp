...
Game::Game() : moveGrounds(false), moveDistance(0), spacePressed(false), enterPressed(false) {
    initSDL();
    loadTextures();
...
void Game::render() {
    ...
    SDL_Rect squareRect = {squareX, squareY - static_cast<int>(squareH), squareW, static_cast<int>(squareH)};
